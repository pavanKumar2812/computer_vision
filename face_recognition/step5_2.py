# face recognition with live video
...
with open('C:/Users/Admin/Desktop/face_recognition/train.pk1','rb') as f:
	names=pickle.load(f)
...
while True:
    ...
    for faceLocation,unknownEncoding in zip(faceLocations,unknownEncodings):
        ...
        cv2.putText(unknownFace,name,(left,top),font,.75,(255,0,0),2)
